    ...
    <el-dialog :title="title" :visible.sync="open" width="700px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="110px">
        ...
        <el-form-item label="参数变量-英文" prop="paramVar">
          <el-select v-model="form.paramVar" style="width: 100%" filterable clearable>
            <el-option v-for="item in pubPropList" :key="item.propVar" :label="item.propVar" :value="item.propVar" />
          </el-select>
          <el-input v-model="form.paramVar" class="para-var" placeholder="请选择或输入参数变量" />
        </el-form-item>
        <el-form-item label="描述-中文" prop="sdesc">
          <el-input v-model="form.sdesc" placeholder="请输入描述-中文" />
        </el-form-item>
        <el-form-item label="参数类型代码" prop="paramTypeCd">
          <el-select v-model="form.paramTypeCd" style="width: 100%" placeholder="请选择参数类型代码" @change="typeSelect(form.paramTypeCd)">
            <el-option v-for="item in paraTypeDict" :key="item.dictValue" :label="item.dictLabel + '-' + item.dictValue" :value="item.dictValue" />
          </el-select>
        </el-form-item>
        <el-form-item label="参数类型名称" prop="paramTypeNm">
          <el-input v-model="form.paramTypeNm" disabled placeholder="请输入参数类型名称" />
        </el-form-item>
