...
<!--      </el-form-item>-->
      <el-form-item label="流程模板PK" label-width="90px" prop="flowTplPk">
        <el-select style="width: 100%" v-model="queryParams.flowTplPk" clearable filterable placeholder="请选择流程模板">
          <el-option v-for="item in flowList" :key="item.flowTplPk" :label="item.tplName" :value="item.flowTplPk"></el-option>
        </el-select>
      </el-form-item>
...
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" @row-click="clickRg" highlight-current-row :data="intfList" @selection-change="handleSelectionChange">
...
<!--          </el-col>-->
          <el-col :span="12">
            <el-form-item label="流程模板"  prop="flowTplPk">
              <el-select style="width: 100%" v-model="form.flowTplPk" clearable filterable placeholder="请选择流程模板">
                <el-option v-for="item in flowList" :key="item.flowTplPk" :label="item.tplName" :value="item.flowTplPk"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
...
<!--          </el-col>-->
          <el-col :span="12">
            <el-form-item label="当前状态" prop="currStatCd">
              <el-select v-model="form.currStatCd" placeholder="请选择当前状态" @change="selectCurrStat(form.currStatCd)" clearable>
                <el-option :label="item.currStatCd + '-' + item.currStatNm" :value="item.currStatCd" v-for="item in currStatusSelect" />
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="当前状态描述" label-width="110px" prop="currStatNm">
              <el-input disabled v-model="form.currStatNm" placeholder="请输入当前状态描述" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="接口类型" prop="intfType">
              <el-select style="width: 100%" v-model="form.intfType" clearable placeholder="请选择接口类型">
                <el-option label="150-Reqt/Resp" value="150"></el-option>
                <el-option label="160-One-Way" value="160"></el-option>
                <el-option label="170-Composite" value="170"></el-option>
                <el-option label="171-Teller Composite,Need Sequence" value="171"></el-option>
                <el-option label="172-Service" value="172"></el-option>
                <el-option label="180-Pub/Sub" value="180"></el-option>
                <el-option label="190-passThrough" value="190"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
<!--          <el-col :span="12">-->
...
export default {
  ...
  methods: {
    ...
    selectCurrStat(currCd) {
      for (let item of this.currStatusSelect) {
