<template>
    <el-dialog title="上传报文配置Excel" :visible.sync="upload.open" modal modal-append-to-body width="400px" append-to-body>
      <el-button @click="dowmloadTmp" type="warning">下载模板</el-button>
      <el-form ref="importExcelForm" :model="importForm" :rules="rules">
        <el-form-item label="报文名" prop="pubfldname">
          <el-input ref="excelPubfldname" v-model="importForm.pubfldname"></el-input>
        </el-form-item>
        ...
        <el-form-item prop="file">
          ...
          >
            ...
            <div class="el-upload__tip" style="color:red" slot="tip">提示：仅允许导入“.xlsx”或“xls”格式文件！</div>
          </el-upload>
        </el-form-item>
      </el-form>
