  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="组件类型" prop="compTypeCd">
        <el-select style="width: 100%" v-model="queryParams.compTypeCd" placeholder="请选择组件类型">
          <el-option v-for="dict in compType" :key="dict.dictValue" :label="dict.dictLabel" :value="dict.dictValue"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="系统类型" label-width="100px" prop="compTypeCd">
              <el-select style="width: 100%" v-model="form.compTypeCd" @change="typeSelect(form.compTypeCd)" placeholder="请选择系统类型">
                <el-option v-for="dict in compType" :key="dict.dictValue" :label="dict.dictLabel" :value="dict.dictValue"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
