...
<!--    </el-row>-->
    ...
    <el-table border v-loading="loading" :data="bndList" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="90px">
        ...
        <el-form-item label="是否代理" prop="isProxy">
          <el-select style="width: 100%"  v-model="form.contentType" placeholder="请选择是否代理">
            <el-option v-for="dict in isProxySelect" :key="dict.dictValue" :label="dict.dictValue + '-' +dict.dictLabel" :value="dict.dictValue" value="" />
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="协议头-类型" prop="contentType">
          <el-select style="width: 100%"  v-model="form.contentType" placeholder="请选择头信息，报文体格式application/json application/xml等">
        ...
        <el-form-item label="协议头-编码" prop="contentCharset">
          <el-select style="width: 100%"  v-model="form.contentCharset" placeholder="请选择头信息编码">
...
<script>
  import { listAttr, getAttr, delAttr, addAttr, updateAttr, exportAttr, listBnd} from "@/api/configuration/attr";
