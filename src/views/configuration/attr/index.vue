  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true" label-width="80px">
      <el-form-item label="协议类型" prop="profileType">
        <el-select v-model="queryParams.profileType" placeholder="请选择协议类型" clearable size="small" @change="handleQuery">
    ...
    <el-dialog :title="title" :visible.sync="open" width="70%" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="协议类型" prop="profileType">
              <el-select v-model="form.profileType" clearable placeholder="请选择协议类型">
                <el-option v-for="item in profileTypes" :key="item.value" :label="item.value" :value="item.value" :index="item.index" />
              </el-select>
            </el-form-item>
          </el-col>
