<template>
  <div class="login">
    <div class="main">
      <div class="left-top">
        <img src="@/assets/logo/dfsp-logo.png" alt="" class="img1">
        <h3>DFSP | 管理配置平台</h3>
        <h4>Data Fusion Service Platform</h4>
      </div>
      <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
        ...
        <el-form-item prop="username">
          ...
          >
            <svg-icon slot="prefix" icon-class="user" :class="{'color-class':isUsername}" class=" input-icon " />
          </el-input>
        </el-form-item>
        <el-form-item prop="password">
          ...
          >
            <svg-icon slot="prefix" icon-class="password" :class="{'color-class':isPassword}" class="el-input__icon input-icon " />
          </el-input>
        </el-form-item>
        <el-form-item prop="code">
          <el-input
            ...
            @keyup.enter.native="handleLogin"
          >
            <svg-icon slot="prefix" icon-class="validCode" :class="{'color-class':isValidCode}" class="el-input__icon input-icon " />
          </el-input>
