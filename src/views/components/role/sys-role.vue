<template>
  <el-dialog v-if="visible" title="角色" :visible.sync="visible" width="60%" append-to-body :close-on-click-modal="false">
    ...
    <div class="app-container">
      ...
      <el-table ref="multipleTable" v-loading="loading" :data="roleList" :row-key="getRowKey" @selection-change="handleSelectionChange">
